...
import { ActiveProspectsPage } from "@/pages/ActiveProspectsPage.jsx";
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
        ...
        <Route path="expedientes" element={<ActiveProspectsPage />} />
        <Route path="workflow" element={<ActiveProspectsPage />} />
