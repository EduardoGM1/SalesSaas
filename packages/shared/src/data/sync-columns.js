/** Columnas mínimas para pull/reconcile (evita select('*') en sync bulk). */
export const SYNC_SELECT = {
  ...
  sales:
    "id,user_id,workspace_id,prospect_id,prospect_name,sale_date,vol,tours,contract,status,processing,process_date,add_processing_followup,note,created_at,updated_at",
  calendar_entries:
    "id,user_id,workspace_id,prospect_id,sale_id,type,entry_date,note,vol,tours,contract,source,status,processing,process_date,completed,kind,client_name,created_at,updated_at",
  goals:
    "user_id,workspace_id,year,month,vol,tours,ventas,dias,descansos,updated_at",
  activities:
    "id,user_id,workspace_id,prospect_id,sale_id,type,title,note,activity_date,source,vol,tours,contract,created_at,updated_at",
  tool_calculations:
    "id,user_id,workspace_id,prospect_id,tool,data,created_at,updated_at",
};
