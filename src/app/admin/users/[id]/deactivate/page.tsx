...
export default async function DeactivateUserPage({
  ...
  await requireAdminPermission("users:deactivate");
  ...
  return (
    <div className="admin-page">
      <div className="admin-page-head">
        ...
        <h1 className="admin-h1">Desactivar cuenta</h1>
        <p className="admin-sub">{name}</p>
      </div>

      <div className="card" style={{ maxWidth: 480 }}>
        <p style={{ marginBottom: 16, lineHeight: 1.6 }}>
          El usuario no podrá iniciar sesión. Sus expedientes, ventas y datos se conservan; la cuenta no se elimina.
        </p>
        <form action={setUserActive}>
          ...
          <div className="btn-row">
            ...
            <button type="submit" className="btn btn-danger">Confirmar desactivación</button>
          </div>
        </form>
      </div>
    </div>
